...
<body class="user-info">
    <form class="layui-form" action="/TrainingSystem/Updateinfo" method="post" id="myform" name="myform">
        <div class="user_left">
            <div class="layui-form-item">
                <label class="layui-form-label">学号</label>
                <div class="layui-input-block">
                    <!-- <input type="text" value="000000006" disabled class="layui-input layui-disabled"> -->
                    <input type="text" value="${userinfo.getStudent_ID() }" disabled class="layui-input layui-disabled" name="userID">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">姓名</label>
                <div class="layui-input-block">
                    <input type="text" value="${userinfo.getStudent_Name() }" class="layui-input userName" placeholder="姓名" name="userName">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" value="${userinfo.getStudent_Password() }" class="layui-input userPassword" placeholder="密码" name="userPassword">
                </div>
            </div>
            <div class="layui-form-item">
...
<%--             <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" value="${groupinfo.getGroup_Name() }" placeholder="学员队" disabled class="layui-input layui-disabled" class="layui-input userGroup" name="userGroup">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
