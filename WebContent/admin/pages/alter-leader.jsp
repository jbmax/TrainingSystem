...
<body class="childrenBody seting-pass">
    <form class="layui-form alter-form" action="/TrainingSystem/AjaxAlterLeader" type="get" lay-filter="alter-form">
        <div class="layui-form-item">
            <label class="layui-form-label">队干部编号</label>
            <div class="layui-input-block">
                <input type="text" value=<%=request.getParameter("id") %> lay-verify="required" class="layui-input" id="id" name="id" readonly>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">队干部姓名</label>
            <div class="layui-input-block">
         ...
         <div class="layui-form-item">
            <label class="layui-form-label">学员队名</label>
            <div class="layui-input-block">
