 ...
 */
@WebServlet("/AjaxAdminList")
public class AjaxAdminList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxAdminList() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Map<String, String>>	lmap= AdminManage.selectAdmin(page, limit);
		...
		else
		{
			jsonObj.put("code", 0);
			jsonObj.put("msg", "");
			jsonObj.put("count", AdminManage.totalnum());
